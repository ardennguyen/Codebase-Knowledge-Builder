...
2. A beginner-friendly `description` explaining what it is, its architectural pattern, and core logic with a simple analogy, in around 150-200 words{desc_lang_hint}.
