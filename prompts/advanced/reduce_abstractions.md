...
2. A comprehensive `description` summarizing the merged concepts and their architectural role{desc_lang_hint}.
...
- name: |
  ...
  description: |
    Combined description of the query processing engine.{desc_lang_hint}
  files:
    - 0 # path/to/file1.py
